...
export function AgendaSlotDialog({ open, slot, onAddLead, onBlock, onClose }: {
  ...
  return <ModalDialog className="agenda-slot-dialog" labelledBy="agenda-slot-title" onClose={onClose}>
    <div className="agenda-dialog__header flex items-start justify-between gap-4"><div><span className="eyebrow">AÇÃO NO HORÁRIO</span><h2 id="agenda-slot-title" className="mt-2">O que você deseja fazer?</h2></div><Button aria-label="Fechar" onClick={onClose}><X aria-hidden="true" /></Button></div>
