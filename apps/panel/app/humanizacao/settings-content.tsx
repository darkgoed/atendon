"use client";
// Corpo de /humanizacao, pronto para o aninhamento em /configuracoes/humanizacao.
// A página legada envolve este conteúdo com o próprio Shell (sem duplicar a navegação).
...
import { HelpHint, IconButton, PageHeader, SaveButton, SaveToast, useSaveFeedback } from "@/components/ui";
...
// Ajuda contextual por grupo (o que cada ajuste muda no comportamento da IA).
const groupHelp: Record<string, string> = {
  readDelay: "Tempo que a IA espera antes de começar a tratar a mensagem recebida.",
  readingPause: "Pausa entre ler a mensagem e começar a responder.",
  composing: "Duração do indicador “digitando…” antes de cada resposta.",
  presence: "Quando o número aparece online e quando fica offline no WhatsApp.",
  debounce: "A IA espera o contato terminar de enviar mensagens em sequência antes de responder.",
  messageSplit: "Divide respostas longas em vários balões, com pausa entre eles.",
  timeOfDayMultiplier: "Multiplica os tempos de espera fora do horário ativo; 1 mantém tudo igual.",
  reaction: "Chance de a IA reagir com um emoji às mensagens do contato.",
  rateLimit: "Máximo de mensagens que a IA envia ao mesmo contato por minuto."
};
...
export function HumanizationSettingsContent() {
