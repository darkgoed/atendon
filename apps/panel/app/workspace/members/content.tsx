        ...
        <>
          <section className="grid4">
            ...
            <div className="card">
              ...
              <div className="metric admin-metric-copy">{workspaceRoleLabel(session?.activeWorkspace?.role)}</div>
                          ...
                          <tr key={member.id}>
                            ...
                            <td data-label="Função">
                              {canUpdateMembers && !member.is_owner_role ? (
                                ...
                                >
                                  {inviteRoles.map((role) => <option key={role.id} value={role.id}>{workspaceRoleLabel(role.name)}</option>)}
                                </select>
                              ) : (
                  ...
                  <tbody>
                    {invitations.map((invitation) => (
                      <tr key={invitation.id}>
                        ...
                        <td data-label="Função"><span className="admin-pill">{workspaceRoleLabel(invitation.role_name)}</span></td>
