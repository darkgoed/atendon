"use client";
// Corpo de /conexao, pronto para o aninhamento em /configuracoes/conexao.
...
export function ConnectionSettingsContent() {
  ...
  return (
    <div className={`${styles.channelsAiPage} channels-ai-page`}>
      ...
      {loaded && whatsappConnections.length === 0 ? <Empty>Nenhuma sessão de WhatsApp configurada.<p className="sub mt-1">Toque em “Adicionar número” para criar a primeira conexão e ler o QR Code.</p></Empty> : null}
