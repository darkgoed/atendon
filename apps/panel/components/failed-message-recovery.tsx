...
export function FailedMessageRecovery({
  ...
  return (
    <section className="card mb-6" aria-labelledby="failed-message-recovery-title">
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div>
            ...
            {recovery.available > 0 ? (
              ...
              <p className="mt-1 text-sm text-[var(--muted)]">Nenhuma mensagem recuperável está aguardando reenvio.</p>
            )}
            {recovery.legacy_unrecoverable > 0 ? (
              <p className="mt-2 text-xs leading-relaxed text-[var(--warn-muted)]">
            ...
            {!connected ? <p className="mt-2 text-xs text-[var(--warn)]">Reconecte o WhatsApp antes de reenviar.</p> : null}
      ...
      {confirming ? (
        <div className="mt-4 border-t border-[var(--warn-border)] pt-4" role="alertdialog" aria-label="Confirmar reenvio de mensagens">
          <p className="text-sm leading-relaxed text-[var(--warn-muted)]">
