...
export function AiStickerLibrary() {
  ...
  return <>
    <header className="pagehead items-start">
      <div>
        <div className="mb-3 flex items-center gap-2 text-[var(--primary)]"><Sticker size={18}/><span className="mono type-caption uppercase tracking-[.16em]">Biblioteca da IA</span></div>
    ...
    <div className="channels-ai-grid xl:grid-cols-[minmax(0,1.45fr)_minmax(300px,.55fr)]">
      ...
      <aside className="grid content-start gap-7">
        ...
        <section className="border-t border-[var(--border)] pt-5">
          <div className="mb-3 flex items-center gap-2"><WhatsappLogo size={18} className="text-[var(--primary)]"/><h2 className="text-base font-semibold">Trazer uma favorita</h2></div>
          <ol className="grid gap-3 text-sm leading-relaxed text-[var(--text-secondary)]">
            <li className="flex gap-3"><span className="mono text-[var(--primary)]">01</span><span>Abra o WhatsApp conectado ao AtendON.</span></li>
            <li className="flex gap-3"><span className="mono text-[var(--primary)]">02</span><span>Envie a figurinha favorita em uma conversa individual.</span></li>
            <li className="flex gap-3"><span className="mono text-[var(--primary)]">03</span><span>Ela aparecerá aqui desativada. Descreva o uso e salve para liberar à IA.</span></li>
          </ol>
