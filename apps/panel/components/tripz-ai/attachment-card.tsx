...
export function TripzAttachmentCard({
  ...
  return (
    ...
    >
      <span className="grid h-[3.25rem] place-items-center overflow-hidden border-r border-[var(--border)] bg-[var(--bg)] text-[var(--primary)]">
        {isImage ? (
      ...
      <span className="grid min-w-0 content-center gap-0.5 px-3 py-2">
        ...
        <span className={`flex min-w-0 items-center gap-1.5 text-[10px] ${failed ? "text-[var(--warning-text)]" : "text-[var(--text-muted)]"}`}>
