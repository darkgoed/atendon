...
export const PERMISSIONS = [
  ...
  { key: "connection.read", module: "connection", action: "read", description: "Visualizar conexões de WhatsApp e Instagram" },
  { key: "connection.manage", module: "connection", action: "manage", description: "Gerenciar conexões de WhatsApp e Instagram" },
