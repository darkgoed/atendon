...
Os volumes têm nomes físicos fixos e adotam os dados existentes sem cópia:
...
Não renomeie, remova ou peça ao Coolify para recriar esses volumes. Os scripts de inicialização do PostgreSQL só atuam em volume vazio.
